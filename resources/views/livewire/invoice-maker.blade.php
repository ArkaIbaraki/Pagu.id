                ...
                <div class="p-3 bg-purple-50 border border-purple-200 rounded-lg">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-gray-500">
                            💡 <a href="https://www.base64-image.de/" target="_blank" class="text-blue-600 hover:underline">Convert image to Base64 →</a>
                        </p>
                    </div>
                    @endif
                </div>
            ...
            <div class="mb-6 space-y-4">
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    ...
                    <div class="space-y-2">
                        <div class="flex space-x-2">
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" wire:model.live="diskonTipe" value="nominal" class="mr-1">
                                <span class="text-sm">Nominal</span>
                            </label>
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" wire:model.live="diskonTipe" value="persen" class="mr-1">
        ...
        <div class="lg:sticky lg:top-6 lg:self-start">
            <div class="bg-white rounded-lg shadow-lg p-8" id="invoice-preview">
                ...
                <div class="mb-6 text-sm border-b border-gray-300 pb-4">
                    <div class="flex justify-between mb-2">
                        ...
                        <div class="text-right">
                            ...
                            <span class="block text-gray-900">{{ \Carbon\Carbon::parse($tanggalInvoice)->format('d F Y') }}</span>
                        </div>
                    </div>
                    @if($namaPenerima)
                    <div class="mb-2">
                    ...
                    <table class="w-full text-sm border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-300">
                                ...
                                <td class="text-right py-2 px-2">Rp {{ number_format((float)($item['harga'] ?? 0), 0, ',', '.') }}</td>
                                @endif
                                <td class="text-right py-2 px-2">
                                    Rp {{ number_format(($modeQuantity ? (float)($item['qty'] ?? 1) : 1) * (float)($item['harga'] ?? 0), 0, ',', '.') }}
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="{{ $modeQuantity ? 5 : 3 }}" class="py-4 text-center text-gray-400">Belum ada item</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                    ...
                    <table class="w-full text-sm border-collapse">
                        <tbody>
                            <tr class="border-b border-gray-300">
                                ...
                                <td class="text-right py-2 px-2 w-32">Rp {{ number_format($this->subtotal, 0, ',', '.') }}</td>
                            </tr>
                            ...
                            <tr class="border-b border-gray-300">
                                ...
                                <td class="text-right py-2 px-2 w-32">Rp {{ number_format($this->diskonValue, 0, ',', '.') }}</td>
                            </tr>
                            @endif
                            ...
                            <tr class="border-b border-gray-300">
                                ...
                                <td class="text-right py-2 px-2 w-32">Rp {{ number_format($this->ppnValue, 0, ',', '.') }}</td>
                            </tr>
                            @endif
                            ...
                            <tr class="border-t-2 border-b-2 border-gray-900">
                                ...
                                <td class="text-right py-2 px-2 w-32 font-bold">Rp {{ number_format($this->total, 0, ',', '.') }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="mt-8 text-right">
                    ...
                    <div class="text-sm font-semibold text-gray-900 border-t border-gray-400 inline-block px-4 pt-1">
                        {{ $namaTtd }}
                    </div>
                </div>
                @endif
