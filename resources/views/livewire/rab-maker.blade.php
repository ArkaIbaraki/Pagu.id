                        ...
                        <div class="space-y-3">
                            ...
                            <div class="text-right">
                                ...
                                <span class="font-bold text-green-700">
                                    Rp {{ number_format((float)($item['volume'] ?? 1) * (float)($item['hargaSatuan'] ?? 0), 0, ',', '.') }}
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="lg:sticky lg:top-6 lg:self-start">
            <div class="bg-white rounded-lg shadow-lg p-8" id="rab-preview">
                <div class="border-b-2 border-gray-300 pb-4 mb-6">
                    ...
                    <h3 class="text-xl font-semibold text-gray-800 text-center mt-2">{{ $namaProyek ?: 'NAMA PROYEK' }}</h3>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="py-2 text-right">Rp {{ number_format((float)($item['hargaSatuan'] ?? 0), 0, ',', '.') }}</td>
